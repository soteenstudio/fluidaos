...
The terminal intentionally does not execute host commands. It supports `help`, `ls`, `cat`, `mkdir`, `touch`, `write`, `clear`, and `date` through the same contained file API used by the graphical apps.
